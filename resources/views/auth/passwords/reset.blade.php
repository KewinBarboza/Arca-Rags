        ...
        <div class="col-md-8">
            ...
            <form method="POST" action="{{ route('password.update') }}">@csrf
                ...
                <div class="form-group row">
                    <div class="col-md-6">
                        <input id="email" type="email" placeholder="Ingrese el correo" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
                ...
                <div class="form-group row mb-0">
                    <div class="col-md-6 offset-md-4">
                        <button type="submit" class="btn verde-s rounded-0">
                            {{ __('Reset Password') }}
                        </button>
                    </div>
                </div>
